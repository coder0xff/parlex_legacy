...
namespace Parlex {
    public class StandardSymbols {
        ...
        static StandardSymbols() {
            ...
            newLine.Nfa.TransitionFunction[newLineState0][CarriageReturnTerminal].Add(newLineState1);
            newLine.Nfa.TransitionFunction[newLineState1][LineFeedTerminal].Add(newLineState2);
            newLine.Nfa.TransitionFunction[newLineState0][LineFeedTerminal].Add(newLineState3);
            ...
            whiteSpaces.Nfa.TransitionFunction[whiteSpacesState0][WhiteSpaceTerminal].Add(whiteSpacesState1);
            whiteSpaces.Nfa.TransitionFunction[whiteSpacesState1][WhiteSpaceTerminal].Add(whiteSpacesState1);
            ...
            StringLiteral.Nfa.TransitionFunction[stringLiteralState0][DoubleQuoteTerminal].Add(stringLiteralState1);
            StringLiteral.Nfa.TransitionFunction[stringLiteralState1][NonDoubleQuoteNonBackSlashCharacterTerminal].Add(stringLiteralState1);
            StringLiteral.Nfa.TransitionFunction[stringLiteralState1][SimpleEscapeSequenceTerminal].Add(stringLiteralState1);
            StringLiteral.Nfa.TransitionFunction[stringLiteralState1][UnicodeEscapeSequenceTerminal].Add(stringLiteralState1);
            StringLiteral.Nfa.TransitionFunction[stringLiteralState1][DoubleQuoteTerminal].Add(stringLiteralState2);
